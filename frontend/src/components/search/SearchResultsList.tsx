...
import { SlidersHorizontal, ArrowUpRight, MapPin, Calendar, Radio } from 'lucide-react';
...
export const SearchResultsList: React.FC<SearchResultsListProps> = ({ results, onSelectResult }) => {
  const { selectedResult, setSelectedResult, setMapCenter, setMapZoom } = useIntelligence();
